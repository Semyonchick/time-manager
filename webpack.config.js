...
module.exports = function makeWebpackConfig() {
  ...
  config.module = {
    rules: [
      ...
      {
        test: /\.ts$/,
        loaders: ['awesome-typescript-loader?' + atlOptions, 'angular2-load-children-loader', 'angular2-template-loader', '@angularclass/hmr-loader'],
  ...
  if (isProd) {
    config.plugins.push(
      ...
      new webpack.optimize.UglifyJsPlugin({sourceMap: true, mangle: { keep_fnames: true }, compress: { warnings: false }}),
